...
const getLitecoinWeeklyPrice = async (req, res) => {
    const listOfDecentralizedCurrency = ["LTC"];
    const frame = "1W";
    const timestampFrom = "2022-12-01T09:30:00Z";
    const timestampTo = "2024-10-04T00:00:00Z";
    const sqlInsert = `INSERT INTO Litecoindata (Litecoin_ID, Name, Symbol, PredictionDate, High, Low, OpenData, CloseData, Volume) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`;
...
module.exports = { getLitecoinWeeklyPrice };
