...
const getAvalancheWeeklyPrice = async (req, res) => {
    const listOfDecentralizedCurrency = ["AVAX"];
    const frame = "1W";
    const timestampFrom = "2022-12-01T09:30:00Z";
    const timestampTo = "2024-10-04T00:00:00Z";
    const sqlInsert = `INSERT INTO Avalanchedata (Avalanche_ID, Name, Symbol, PredictionDate, High, Low, OpenData, CloseData, Volume) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`;
...
module.exports = { getAvalancheWeeklyPrice};
